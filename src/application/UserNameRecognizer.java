	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				// A-Z, a-z, 0-9 -> State 1
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for the first character being A-Z, or a-z
			...
			case 1: 
				...
				//  2: special characters which transition to state 2 
				...
				// . -> State 2
				else if (currentChar == '.' || currentChar == '_' || currentChar == '-') {	// Check for special characters
					nextState = 2;
